...
export interface LiquidityGaugeV4Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "decimal_staking_token",
    values?: undefined
  ): string;
...
export type RewardDataUpdateEvent = TypedEvent<
  [string, BigNumber],
  { _token: string; _amount: BigNumber }
>;

export type RewardDataUpdateEventFilter =
  TypedEventFilter<RewardDataUpdateEvent>;
