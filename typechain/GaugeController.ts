...
export interface GaugeControllerInterface extends utils.Interface {
  ...
  events: {
    ...
    "KilledGauge(address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "KilledGauge"): EventFragment;
}
...
export type KilledGaugeEvent = TypedEvent<[string], { addr: string }>;

export type KilledGaugeEventFilter = TypedEventFilter<KilledGaugeEvent>;
...
export interface GaugeController extends BaseContract {
  ...
  filters: {
    ...
    "KilledGauge(address)"(addr?: null): KilledGaugeEventFilter;
    KilledGauge(addr?: null): KilledGaugeEventFilter;
  };
