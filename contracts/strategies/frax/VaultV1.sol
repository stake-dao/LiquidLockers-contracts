...
contract StakingProxyBase is IProxyVault {
    ...
    //initialize vault
    function initialize(address _owner, address _stakingAddress, address _stakingToken, address _rewardsAddress)
        external
        virtual
        override
    {}
...
contract VaultV1 is StakingProxyBase, ReentrancyGuard {
    ...
    function earned()
        ...
        view
        override
        returns (address[] memory _token_addresses, uint256[] memory _total_earned)
    {
