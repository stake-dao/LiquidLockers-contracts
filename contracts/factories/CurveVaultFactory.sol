...
import "../strategies/curve/CurveVault.sol";
...
contract CurveVaultFactory {
    ...
    constructor(address _gaugeImpl, address _curveStrategy, address _sdtDistributor) {
     ...
     */
    function cloneVault(address _impl, ERC20Upgradeable _lpToken, bytes32 _paramsHash) internal returns (CurveVault) {
        address deployed =
