...
contract AngleVaultFactory {
    ...
    constructor(address _gaugeImpl, address _angleStrategy, address _sdtDistributor) {
    ...
    function _cloneAndInitVault(
        ...
        AngleVault deployed =
            cloneVault(_impl, _lpToken, keccak256(abi.encodePacked(_governance, _name, _symbol, angleStrategy)));
     ...
     */
    function cloneVault(address _impl, ERC20Upgradeable _lpToken, bytes32 _paramsHash) internal returns (AngleVault) {
        address deployed =
