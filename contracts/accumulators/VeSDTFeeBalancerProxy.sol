...
contract VeSDTFeeBalancerProxy is Ownable {
    ...
    function sendRewards() external {
        ...
        IBalancerVault.BatchSwapStep memory stepBalWeth =
            IBalancerVault.BatchSwapStep(BAL_WETH_P_ID, 0, 1, balBalance - claimerPart, "");
        ...
        IBalancerVault.FundManagement memory fm =
        ...
        IBalancerVault(BALANCER_VAULT).batchSwap(
            IBalancerVault.SwapKind.GIVEN_IN, steps, assets, fm, limits, block.timestamp + 1800
        );
