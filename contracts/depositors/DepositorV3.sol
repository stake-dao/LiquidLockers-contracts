...
import "../interfaces/ISdTokenV2.sol";
...
/// 2023-03-24: setSdTokenOperator() -> setSdTokenMinterOperator()
contract DepositorV3 {
    ...
    /* ========== CONSTRUCTOR ========== */
    constructor(address _token, address _locker, address _minter, uint256 _maxTime) {
