...
contract AngleMerkleClaimTest is Test {
    ...
    function claimReward(
        ...
        require(
            balanceAngleAfterAgEurEthLG - balanceAngleBeforeAgEurEthLG == _amountsToNotify[0], "wrong amount received"
        );
        require(
            balanceAngleAfterAgEurUsdcLG - balanceAngleBeforeAgEurUsdcLG == _amountsToNotify[1], "wrong amount received"
        );
