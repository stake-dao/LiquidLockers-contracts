...
contract FraxVoterTest is Test {
	...
	function testVoting() public {
		IGaugeController.VotedSlope memory vote = IGaugeController(fxsGaugeController).vote_user_slopes(
			fxsLocker,
			0x698137C473bc1F0Ea9b85adE45Caf64ef2DF48d6
		);
		...
		IGaugeController.VotedSlope memory afterVoted = IGaugeController(fxsGaugeController).vote_user_slopes(
			fxsLocker,
			0x698137C473bc1F0Ea9b85adE45Caf64ef2DF48d6
		);
