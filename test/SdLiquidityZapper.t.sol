...
contract SdLiquidityZapperTest is Test {
    ...
    function setUp() public {
        ...
        sdLiquidityZapper.addDepositorForCurveBased(
            address(CRV), SDCRV, CRVDEPOSITOR, CRVSDCRVCURVEPOOL, CRVSDCRVSTRATEGYVAULT
        );
        sdLiquidityZapper.addDepositorForCurveBased(
            address(ANGLE), SDANGLE, ANGLEDEPOSITOR, ANGLESDANGLECURVEPOOL, ANGLESDANGLESTRATEGYVAULT
        );
    ...
    function testZapIntoSdCRV() public {
        ...
        sdLiquidityZapper.zapToSdCurvePool(
            address(CRV), 100e18, 50e18, 0, CRVSDCRVCURVEPOOL, CRVSDCRVSTRATEGYVAULT, true, true
        );
    ...
    function testZapIntoSdAngle() public {
        ...
        sdLiquidityZapper.zapToSdCurvePool(
            address(ANGLE), 100e18, 50e18, 0, ANGLESDANGLECURVEPOOL, ANGLESDANGLESTRATEGYVAULT, true, true
        );
    ...
    function testZapIntoSdCRVSingleSide() public {
        ...
        CRV.approve(address(sdLiquidityZapper), 100e18);
        sdLiquidityZapper.zapToSdCurvePool(
            address(CRV), 100e18, 0, 0, CRVSDCRVCURVEPOOL, CRVSDCRVSTRATEGYVAULT, true, true
        );
        uint256 balanceAfterZap = IERC20(CRVSDCRVSTRATGAUGE).balanceOf(address(this));
